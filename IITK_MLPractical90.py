...
#--------------------------------------------------
#1)Logistic Regression (Based on Sigmoid function)
# from sklearn.linear_model import LogisticRegression

#2)Linear Discriminant Analysis(LDA). (High Dim--->Low Dim)
# from sklearn.discriminant_analysis import LinearDiscriminantAnalysis

#3)k-Nearest Neighbors (kNN).
# from sklearn.neighbors import KNeighborsClassifier

#4)Naive Bayes (=NB = GaussianNB) (Based on Conditional Probability)
# from sklearn.naive_bayes import GaussianNB

#5)DecisionTree or Classification and Regression Trees(CART)(Based on Entropy & I.Gain)
# from sklearn.tree import DecisionTreeClassifier

#6)Support Vector Machines (svm) (SVC-Support Vector Classifier)
# from sklearn.svm import SVC

#7)RandomForestClassifier (Ensemble of D.Tree)
